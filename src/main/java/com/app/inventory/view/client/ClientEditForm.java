 ...
 * @author frank
 */
public class ClientEditForm extends javax.swing.JFrame {
	...
	Date date = new Date();
        ...
        Client client = clientController.findClient(idClient);
        ...
        try {
            ...
            System.out.println("com.app.inventory.view.ClientEditForm.btnSaveActionPerformed()");
            Logger.getLogger(ClientEditForm.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClientEditForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClientEditForm().setVisible(true);
            }
        });
    }
