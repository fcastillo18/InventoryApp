...
public class ProductEditForm extends javax.swing.JFrame {
	...
	Date date = new Date();
        ...
        product.setName(txtName.getText() + " " + txtLastName.getText());
        ...
        try {
            ...
            System.out.println("com.app.inventory.view.ProductEditForm.btnSaveActionPerformed()");
    ...
    private void loadProductDataOnForm(){
        Product product = productController.findProduct(idProduct);
        txtAddress.setText(product.getAddress());
        txtAreaNote.setText(product.getNote());
        txtDocument.setText(product.getDocument());
        txtEmail.setText(product.getEmail());
        txtLastName.setText(product.getName().split(" ")[1]);
        txtName.setText(product.getName().split(" ")[0]);
