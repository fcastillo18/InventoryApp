 ...
 */
public class ProductEntryFormBCK extends javax.swing.JFrame {
                ...
                inventoryController.findInventoryEntities().forEach(i -> {
                    if (Objects.equals(inv.getIdProduct(), i.getIdProduct())) { 
                        try {
                            ...
                            Logger.getLogger(ProductEntryFormBCK.class.getName()).log(Level.SEVERE, null, ex);
                        }
                    }
                });
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProductEntryFormBCK.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProductEntryFormBCK().setVisible(true);
            }
        });
    }
