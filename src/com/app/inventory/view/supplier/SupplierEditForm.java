 ...
 * @author frank
 */
public class SupplierEditForm extends javax.swing.JFrame {
	...
	Date date = new Date();
        ...
        Supplier supplier = supplierController.findSupplier(idSupplier);
        ...
        try {
            supplierController.edit(supplier);
        } catch (Exception ex) {
            System.out.println("com.app.inventory.view.SupplierEditForm.btnSaveActionPerformed()");
            Logger.getLogger(SupplierEditForm.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        loadSupplierDataOnForm();
    }//GEN-LAST:event_formWindowOpened

    
    private void loadSupplierDataOnForm(){
        Supplier supplier = supplierController.findSupplier(idSupplier);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SupplierEditForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SupplierEditForm().setVisible(true);
            }
        });
    }
