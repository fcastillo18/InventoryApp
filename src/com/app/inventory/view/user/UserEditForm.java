...
public class UserEditForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(78, 78, 78)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtZone, javax.swing.GroupLayout.DEFAULT_SIZE, 162, Short.MAX_VALUE)
	...
	Date date = new Date();
        ...
        Users users = usersController.findUsers(idUsers);
        users.setName(txtName.getText() + " " + txtLastName.getText());
        users.setAddress(txtAddress.getText());
        //users.setCreatedDate(new java.sql.Timestamp(date.getTime()));
        users.setDocument(txtDocument.getText());
        users.setEmail(txtEmail.getText());
        users.setNote(txtAreaNote.getText());
        users.setPhone(txtPhone.getText());
        users.setStatus(true);//activo
        users.setZone(txtZone.getText());
        try {
            usersController.edit(users);
        } catch (Exception ex) {
            System.out.println("com.app.inventory.view.UsersEditForm.btnSaveActionPerformed()");
    ...
    private void loadUsersDataOnForm(){
        Users users = usersController.findUsers(idUsers);
        txtAddress.setText(users.getAddress());
        txtAreaNote.setText(users.getNote());
        txtDocument.setText(users.getDocument());
        txtEmail.setText(users.getEmail());
        txtLastName.setText(users.getName().split(" ")[1]);
        txtName.setText(users.getName().split(" ")[0]);
        txtPhone.setText(users.getPhone());
        txtZone.setText(users.getZone());
    }
    /**
